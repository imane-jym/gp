...
//        void outErrorDb( const char * str, ... )                ATTR_PRINTF(2, 3);
        ...
        void outCharBySeq(const char * seq, const char * str, ... )                   ATTR_PRINTF(3, 4);
...
//        void outDollar( const char* str, ... )               ATTR_PRINTF(2, 3);
        ...
        static void outTimestampBySeq(FILE* file, const char *str);
...
#define IME_CHAR_LOG(userid,opt,fmt, ...)		sLog->outCharBySeq("\t", "%u\t%s\t"fmt, userid, opt, ##__VA_ARGS__)
