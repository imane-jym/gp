...
public:
	...
	static bool GetExtendReward( const char* strTableName, uint8 byIdType, uint32 dwRoleId, uint32& dwItemId, uint32& dwItemCnt, uint8& byState );
	static bool SetExtendRewardGot( const char* strTableName, uint8 byIdType, uint32 dwRoleId, uint8 byState );
	...
	static bool InsertCharge(uint32 dwGoodsId, uint32 dwRoleId, uint32 dwNumber);
